...
all_ok &= check(
    "native_custom_racer.c : NATIVE_VOICE_TRACK_BASE defined",
    "#define NATIVE_VOICE_TRACK_BASE" in t,
)
all_ok &= check(
...
all_ok &= check(
    ...
    and "Custom voicelines: enqueue in the retail Voiceline2 list" in t,
)
all_ok &= check(
